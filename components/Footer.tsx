...
export default function Footer() {
  ...
  const authPath = (path: string) => isLoggedIn ? path : "/login";
    ...
    >
      <div className="bg-[#4882a1] px-6 py-12 md:px-12 lg:px-24">
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* Columna 2: Cuenta (Actualizada con Notificaciones y Ayuda) */}
          <div className="flex flex-col">
            <h3 className="text-xl font-bold mb-6">Cuenta</h3>
            <ul className="space-y-4">
              <li>
                <Link href={authPath("/cuenta")} className="hover:text-gray-200 transition-colors">
                  {isLoggedIn ? "Mi Perfil" : "Iniciar Sesión"}
                </Link>
              </li>
              <li>
                <Link href={authPath("/cuenta/reservaciones")} className="hover:text-gray-200 transition-colors">
                  Mis Reservaciones
                </Link>
              </li>
              <li>
                <Link href={authPath("/cuenta/notificaciones")} className="hover:text-gray-200 transition-colors">
                  Notificaciones
                </Link>
              </li>
              <li>
                <Link href={authPath("/cuenta/ayuda")} className="hover:text-gray-200 transition-colors">
                  Centro de Ayuda
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col">
            <h3 className="text-xl font-bold mb-6">Tekdrive Rent a Car</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 flex-shrink-0 text-white">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                </svg>
                <span className="pt-0.5 text-sm">2 calle 8 y 9 ave N.O.<br/>Guamilito, San Pedro Sula</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm">+504 9673-2842</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4">
              {/* Facebook, Instagram, LinkedIn SVG Links... */}
      ...
      {/* Barra Inferior */}
      <div className="bg-[#2a4555] px-6 py-5 md:px-12 lg:px-24 text-center sm:text-left">
        <div className="max-w-screen-xl mx-auto flex flex-col sm:flex-row justify-between items-center text-sm gap-4 opacity-80">
          <p>Copyright © Tekdrive Rent a Car 2022-{currentYear}</p>
          <a href="https://indevasa.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
            Indeva Websites
          </a>
        </div>
      </div>
